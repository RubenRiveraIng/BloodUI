...
import { ClinicasBancosSangreService } from '../../service/ClinicasBancosSangre.service';
import { ClinicasBancosSangre } from '../../model/ClinicasBancosSangre';
import { loader } from '../generico/loader';

@Component({
  selector: 'page-clinicasbancos.page',
  templateUrl: 'clinicasbancos.page.html',
  providers: [GoogleMaps, Geolocation, ClinicasBancosSangreService,loader]
})
export class ClinicasbancosPage {
  ...
  private _cbsService: ClinicasBancosSangreService;
  private _lstcbs: Array<ClinicasBancosSangre>;
  ...
  constructor(
    ...
    private cbsService: ClinicasBancosSangreService,
    private loader: loader
  ) {
    this._loader = loader;
    this._loader.showLoader();
    this._cbsService = cbsService;
    this._lstcbs = new Array<ClinicasBancosSangre>();
  }
  ...
  private getCBSPoint() {
    this._cbsService.getClinicas().subscribe(data => {
      this._lstcbs = data;
